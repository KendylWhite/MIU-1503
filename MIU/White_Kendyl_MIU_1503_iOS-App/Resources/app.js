...
//Window
var winRide = Titanium.UI.createWindow({
    backgroundImage: 'images/burn.jpg',
    navBarHidden : "true",
});

//Nav Window
var winOut = Titanium.UI.iOS.createNavigationWindow({
   window: winRide
});

//Window
var winCars = Titanium.UI.createWindow({
...
button.addEventListener('click', function(){
    winOut.openWindow(winCars, {animated:true});
});
